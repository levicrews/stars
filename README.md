...
- [bdarcus/citar](https://github.com/bdarcus/citar) - A package to quickly find and act on BibTeX, BibLaTeX and CSL JSON entries using default Emacs completion; especially Selectrum/Vertico with Consult and Embark.
